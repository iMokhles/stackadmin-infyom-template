                    ...
                    <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal" method="post" action="{{ url('/password/email') }}" novalidate>
                                        {!! csrf_field() !!}
                                        ...
                                        <button type="submit" class="btn btn-outline-primary btn-lg btn-block"><i class="ft-unlock"></i> Send Password Reset Link</button>
                                    </form>
                                </div>
                            </div>
                            <div class="card-footer border-0">
                                <p class="float-sm-left text-center"><a href="{{ url('/login') }}" class="card-link">Login</a></p>
                                <p class="float-sm-right text-center">New to Stack ? <a href="{{ url('/register') }}" class="card-link">Create Account</a></p>
                            </div>
                        </div>
                    </div>
                </div>
